  ...
  function enviar(){
    ...
    if(arreglos.length==0){
      arreglos.push({productss,idCart:arreglos.length+1})
        ...
        localStorage.setItem("costo",productss.price)
      ...
      JSON.parse(localStorage.getItem("datos")).map(function(d){

        m = m+d.productss.price
      })

      localStorage.setItem("costo",m)
      }
      router.refresh()
                  ...
                  <div className="grid w-full grid-cols-1 items-start gap-x-6 gap-y-8 sm:grid-cols-12 lg:gap-x-8">
                    ...
                    <div className="sm:col-span-8 lg:col-span-7">
                      ...
                      <section aria-labelledby="information-heading" className="mt-2">
                        ...
                        <p className="text-2xl text-gray-900">{"Q"+productss.price+".00"}</p>
